    ...
    <div className="">
      ...
      <div className="bg-white pb-5  ">
        <div className="flex justify-center pt-2 gap-5">
          <div>
            <div>
              {console.log(squadData?.latest_inning_number)}
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          <tr className="border-b">
                            ...
                            <td className="pl-3">
                              {
                                extractPowerplayData2(squadData?.match_notes)
                                  ?.over
                              }
                            </td>
                            <td
                                    ...
                                    {squadData?.innings?.[2]?.did_not_bat?.map(
                                      (player, index) => (
                                        ...
                                        >
                                          {player?.name}
                                          {index !==
                                            squadData.innings[2].did_not_bat
                                              .length -
                                              1 && ","}
                                        </span>
                                      )
                              ...
                              <table className="w-full">
                                ...
                                <tbody>
                                  <tr className="border-b">
                                    ...
                                    <td className="pl-3">
                                      {
                                        extractPowerplayData2(
                                          squadData?.match_notes
                                        )?.over
                                      }
                                    </td>
                                    <td
                                    ...
                                    {squadData?.innings?.[3]?.did_not_bat?.map(
                                      (player, index) => (
                                        ...
                                        >
                                          {player?.name}
                                          {index !==
                                            squadData.innings[1].did_not_bat
                                              .length -
                                              1 && ","}
                                        </span>
                                      )
