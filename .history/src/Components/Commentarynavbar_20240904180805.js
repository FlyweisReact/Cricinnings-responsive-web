        ...
        >
          <div style={{ lineHeight: "1.1rem" }}>
            ...
            <p
              ...
              className='small-text bold-font'
            >
            ...
            <p
              ...
              className='xs-small-text bold-font'
            >
            ...
            <div className="ml-4 mb-1">
              <div className="d-flex gap-4 ">
                {squadData?.man_of_the_match?.name && (
                  <p className="CommentartyData1 small-text">
                    Man of the match :{" "}
          ...
          <div>
            {matchData1?.status === 3 && (
              <div style={{ width: "600px", fontSize: "14px" }} className='full-width' >
                <div>
                  <Table responsive className="m-2 ml-0 zero-margin">
                    <thead>
                ...
                {matchData1?.status !== 1 && (
                  <div>
                    <Table responsive className="m-2 zero-margin">
                      <thead>
                        <tr className="border-b">
                          <th
                            style={{
