    ...
    <div className="">
      <div className="container_terms full-width" style={{ width: "95%", margin: "auto" }}>
        <div class="bg-white p-8 max-w-4xl mx-auto small-padding">
          <h1 class="text-3xl font-bold mb-6 text-center medium-text zero-margin">Terms and Conditions</h1>

          <p class="mb-4 text-sm text-gray-600 xs-small-text">Please read the below terms and conditions carefully before using our website, CricInnings accessible at https://cricinnings.com</p>

          <h2 class="text-2xl font-semibold mb-4 small-text zero-margin">Welcome to CricInnings!</h2>

          <p class="mb-4 xs-small-text zero-marign">These terms and conditions outline the rules and regulations for the use of CricInnings's Website, located at https://cricinnings.com/.</p>

          <p class="mb-4">By accessing this website we assume you accept these terms and conditions. Do not continue to use CricInnings if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p class="mb-4">We employ the use of cookies. By accessing CricInnings, you agreed to use cookies in agreement with CricInnings's Privacy Policy.</p>

          <h3 class="text-xl font-semibold mb-3 mt-6">License</h3>
          <p class="mb-4">Unless otherwise stated, CricInnings and/or its licensors own the intellectual property rights for all material on CricInnings. All intellectual property rights are reserved. You may access this from CricInnings for your own personal use subject to restrictions set in these terms and conditions.</p>
