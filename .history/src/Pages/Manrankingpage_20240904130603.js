...
import { AdSideBanner } from "../Components/HelpingComponent";
          ...
          {mainCategory === "batting" && (
            <>
              <div>
                ...
                <div className="w-[680px] pb-5 mt-2 bg-white rounded-lg full-width box-shadow-container display-none">
                    ...
                    <div className="flex items-center justify-between ml-10 mr-10">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <span className="font-semibold xs-small-text">
                            Kane Williamson
                          </span>
                          <span className="text-[12px] xs-small-text">
                            NEW ZEALAND
                          </span>
                        </div>
                      </div>
