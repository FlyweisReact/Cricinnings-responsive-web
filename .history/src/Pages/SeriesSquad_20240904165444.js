  ...
  return (
    <div className="">
      <div className="bg-[white] pl-2 pt-2 pr-2">
        ...
        <div className="schedule-squad column-flex">
          <div className="mt-3 p-1 full-width" style={{ width: "250px" }}>
                    ...
                    ?.map((item) => {
                      return (
                        <div
                          ...
                          className="text-lg font-normal cursor-pointer hover:underline small-text"
                        >
