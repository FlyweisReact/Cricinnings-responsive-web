    ...
    <div className="">
      <div className="bg-[white] pl-2 pt-2 pr-2">
        ...
        <div className="flex mt-2 justify-center pb-5">
          <div className="w-[950px] pb-5 bg-[white] flex justify-center gap-5 pt-5 full-width column-flex sero-padding">
            <div className="mt-1 box-shadow-container w-[700px] ml-3 full-width">
              <div
            ...
            <div className="w-[250px] mt-10 box-shadow-container">
