        ...
        {true && (
          <div className="flex justify-center pt-2 gap-5 main-div">
            <div>
              ...
              <div className="text-sm mt-2 font-semibold medium-text">Editors Pick</div>

              <div className="w-[650px] h-[300px]  mt-2 pt-4 bg-white rounded-lg  shadow-lg full-width small-padding">
