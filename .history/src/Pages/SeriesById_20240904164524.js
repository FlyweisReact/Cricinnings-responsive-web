            ...
            {selectedButton === "Current Matches" && (
              <>
                <div className="flex mt-2 justify-center pb-5">
                  <div className="w-[950px] pb-5 bg-[white] flex justify-center gap-5 pt-5 full-width zero-padding">
                    <div className="left w-[950px]  ">
                      <Table style={{ border: "none", fontSize: "14px" }} responsive>
                        <thead style={{ textAlign: "left" }}>
                          <tr>
                            <th
                              style={{ backgroundColor: "#EDEAEA" }}
                              className="w-[100px] bold-font"
                            >
                              Date
                            </th>
                            <th
                                ...
                                >
                                  ...
                                  >
                                    <span className="hover:underline">
                                      <h1 className="text-base small-text">
                                        {item?.title +
                                          "," +
                                    ...
                                    <span style={{ color: "gray" }} className='xs-small-text' >
                                      {item?.venue?.name +
                                        " - " +
                                        item?.venue?.location}
                                    </span>
