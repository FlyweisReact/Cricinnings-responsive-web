    ...
    <div className="">
      <div className="container_terms full-width" style={{ width: "95%", margin: "auto" }}>
        <div class="bg-white p-8 max-w-4xl mx-auto small-padding">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-6 small-text">Cookies</h3>
          <p class="mb-4 xs-small-text">We employ the use of cookies. By accessing CricInnings, you agreed to use cookies in agreement with CricInnings's Privacy Policy.</p>

          <h3 class="text-xl font-semibold mb-3 mt-6 small-text">License</h3>
          <p class="mb-4 xs-small-text">Unless otherwise stated, CricInnings and/or its licensors own the intellectual property rights for all material on CricInnings. All intellectual property rights are reserved. You may access this from CricInnings for your own personal use subject to restrictions set in these terms and conditions.</p>
