  ...
  return (
    <div className="">
      ...
      <div className="bg-[white] pl-2 pt-2 pr-2">
        ...
        <div className="flex mt-5 justify-center pb-5 cricket-news-container">
          <div className="w-[950px] pb-5 bg-[white] flex justify-center gap-5 pt-5 full-width column-flex zero-margin">
