    ...
    <div className="">
      <div className="container_terms full-width" style={{ width: "95%", margin: "auto" }}>
        <div class="bg-white p-8 max-w-4xl mx-auto small-padding">
          ...
          <p class="mb-4 xs-small-text zero-margin">These terms and conditions outline the rules and regulations for the use of CricInnings's Website, located at https://cricinnings.com/.</p>
