...
const MyComponent = ({}) => {
  return (
    <div className="w-[250px] mt-10 zero-margin full-width">
      ...
      {middleBanner2 && (
        <img src={middleBanner2} alt="" className="ad-side-banner mt-2 mb-2" />
      )}

      <div className="bg-[white] pt-3 pb-3 rounded-lg mt-2 box-shadow-container small-padding">
        <div className="flex justify-between p-2">
          <div className="text-sm font-semibold small-text">RANKING’s</div>
          <div>
      ...
      {bottomBanner1 && (
        <img src={bottomBanner1} alt="" className="ad-side-banner mt-2 mb-2" />
      )}
