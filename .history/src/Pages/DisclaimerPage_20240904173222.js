  ...
  return (
    <div className="px-4 py-8">
      <div class="bg-white p-8 zero-padding">
        ...
        <div>
          <p>
            <span style={{fontSize : '13px' , color : "rgb(33,33,33)"}}  style="font-size: 13pt; color: rgb(33, 33, 33);">
          ...
          <h2>
            <strong style="font-size: 22.5pt;">
              Disclaimers for CricInnings
            </strong>
          </h2>
          <p>
            <span style="font-size: 13pt; color: rgb(33, 33, 33);">
