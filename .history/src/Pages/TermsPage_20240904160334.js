    ...
    <div className="">
      <div className="container_terms full-width" style={{ width: "95%", margin: "auto" }}>
        <div class="bg-white p-8 max-w-4xl mx-auto small-padding">
          ...
          <p class="mb-4 small-text">These terms and conditions outline the rules and regulations for the use of CricInnings's Website, located at https://cricinnings.com/.</p>

          <p class="mb-4 small-text">By accessing this website we assume you accept these terms and conditions. Do not continue to use CricInnings if you do not agree to take all of the terms and conditions stated on this page.</p>

          <p class="mb-4 small-text">The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice, and all Agreements: "Client", "You" and "Your" refers to you, the person who logs on this website and is compliant with the Company's terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves.</p>
          ...
          <h4 class="text-lg font-normal mb-2 mt-4 medium-text">You must not:</h4>
          ...
          <h3 class="text-xl font-semibold mb-3 mt-6 medium-text">Contact Us</h3>
          <p class="mb-2 small-text">If you have any questions about these Terms and Conditions, You can contact us:</p>
          <ul class="list-disc pl-6">
            <li className="small-text">By visiting <a href="https://cricinnings.com/contact-us/" class="text-blue-600 hover:underline">https://cricinnings.com/contact-us/</a></li>
            <li className="small-text">Email at <a href="mailto:cricinnings17@gmail.com" class="text-blue-600 hover:underline">cricinnings17@gmail.com</a></li>
          </ul>
        </div>
        <div
