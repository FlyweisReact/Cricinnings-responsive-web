        ...
        <div className="cricket-news-container">
          <div className="w-[950px] pb-5 bg-[white] flex justify-center gap-5 pt-5 full-width column-flex zero-margin main-container">
                      ...
                      <div className="w-full p-2">
                        <div className="news-card">
                          ...
                          <div className="content">
                            ...
                            <div className="xs-small-text">{item?.description}</div>
            ...
            <div className="w-[250px]  mt-10 zero-margin full-width small-padding">
              ...
              <div className="bg-[white] rounded-lg mt-2 box-shadow-container small-padding">
                <div className="p-1">
                  ...
                  {specialBanner?.map((item) => (
                    <>
                      ...
                      <span className="font-semibold text-sm ml-4 xs-small-text">
                        {item?.subtitle}
                      </span>
