                ...
                <>
                      ...
                      <table className="p-2">
                        <thead className="border-b">
                          ...
                          >
                            <th
                              style={{ borderRadius: "10px 0 0 0" }}
                              className="w-[350px] pl-3 text-left xs-small-text"
                            >
                              Bowler
                            </th>
                            <th className="w-[50px] text-left xs-small-text">O</th>
                            <th className="w-[50px] text-left xs-small-text">M</th>
                            <th className="w-[50px] text-left xs-small-text">R</th>
                            <th className="w-[50px] text-left xs-small-text">W</th>
                            <th className="w-[50px] text-left xs-small-text">NB</th>
                            <th className="w-[50px] text-left xs-small-text">WD</th>
                            <th
                              style={{ borderRadius: "0 10px 0 0" }}
                              className="w-[50px] text-left xs-small-text"
                            >
                              ECO
                            </th>
                          </tr>
                      ...
                      <table className="w-full">
                        <thead className="border-b">
                          ...
                          >
                            <th
                              style={{ borderRadius: "10px 0 0 0" }}
                              className="w-[350px] pl-3 text-left overflow-hidden xs-small-text"
                            >
                              Powerplays
                            </th>
                            <th className="w-[150px] text-left xs-small-text"> Over</th>
                            <th
                              style={{ borderRadius: "0 10px 0 0" }}
                              className="w-[150px] text-left xs-small-text"
                            >
                              Runs
                            </th>
                          </tr>
                      ...
                      <table className="w-full">
                        <thead className="border-b">
                          <tr
                            ...
                            style={{ borderRadius: "10px 10px 0 0" }}
                          >
                            <th className="w-[350px] pl-3 text-left overflow-hidden xs-small-text">
                              Fall Of Wickets
                            </th>
                            <th className="w-[150px] text-left"></th>
                            <th className="w-[150px] text-left xs-small-text">Score</th> 
                            <th className="w-[150px] text-left xs-small-text">Over</th>
                          </tr>
                        </thead>
                        <tbody>
                  ...
                  {squadData?.innings?.length === 4 && (
                    <div>
                      <div className="w-[680px]  mt-2 mb-2 bg-[white] rounded-lg  shadow-lg full-width">
                        <div className="bg-[#0F19AF] flex justify-between items-center  rounded-t-lg w-full h-[45px] text-white">
                          <div className="ml-2 xs-small-text">
                            {squadData?.innings?.[2]?.name}
                          </div>
                          <div className="mr-2 xs-small-text">
