  ...
  return (
    <div className="">
      ...
      <div className="bg-white pb-5">
                ...
                <>
                  <div className="full-width small-padding">
                    <div className="w-[680px] mt-2 mb-2 bg-[white] rounded-lg  shadow-lg full-width ">
                        ...
                        <table className="m-2">
                          <thead>
                            <tr className="border-b">
                              <th className="w-[150px] text-left xs-small-text">
                                Batter
                              </th>
                              <th className="w-[300px]"></th>
                              <th className="w-[50px] text-left xs-small-text">
                                R
                              </th>
                              <th className="w-[50px] text-left xs-small-text">
                                B
                            ...
                            {squadData?.innings?.[0]?.batsmen?.map(
                              (item, index) => (
                                <tr key={index} className="border-b">
                                  <td
                                    className="text-[#0F19AF] hover:underline hover:cursor-pointer xs-small-text"
                                    onClick={() =>
                                      navigate(
                                        `/profiles/${
                                          item?.batsman_id
                                  ...
                                  <td className="xs-small-text">{item.runs}</td>
                                  <td className="xs-small-text">
                                    {item.balls_faced}
                                  </td>
                                  <td className="xs-small-text">
                                  ...
                                  <td className="flex items-center xs-small-text">
                                    {item.strike_rate}
                                  </td>
                                </tr>
                              )
                      ...
                      <div className="border-b  ml-2 mr-2">
                        <div className="flex justify-between w-[550px] full-width">
                          <div className="text-slate-400 xs-small-text bold-font">
                            EXTRAS
                          </div>
                          <div className="text-slate-400 flex xs-small-text bold-font">
                            {formatExtraRuns(
                      ...
                      <div className="border-b ml-2 mr-2">
                        <div className="flex  justify-between w-[550px] full-width">
                          ...
                          <div className="flex xs-small-text bold-font">
                      ...
                      <div className="flex ml-2 w-[680px] full-width">
                        <div
                          style={{ width: "150px" }}
                          className="text-slate-400 pr-14 xs-small-text bold-font"
                        >
                          Didn’t Bat
                        </div>
                            ...
                            {squadData?.innings?.[0]?.did_not_bat?.map(
                              (player, index) => (
                                <span
                                  ...
                                  className="hover:underline hover:cursor-pointer xs-small-text bold-font"
                                  key={index}
                                >
                                  {player?.name}
                                  {index !==
                    ...
                    <div className="w-[680px]  mt-2 bg-[white] rounded-lg  shadow-lg full-width">
                      <div className="overflow-div">
                        <table className="p-2">
                          <thead className="border-b">
                            <tr
                              style={{ borderRadius: "10px 0 10px 0" }}
                              className="bg-[#0F19AF] rounded-t-lg w-[680px] h-[45px] text-white full-width"
                            >
                              <th
                                style={{ borderRadius: "10px 0 0 0" }}
                                className="w-[350px] pl-3 text-left small-text"
                              >
                                Bowler
                              </th>
                              <th className="w-[50px] text-left small-text">
                                O
                              </th>
                              <th className="w-[50px] text-left small-text">
                                M
                              ...
                              <th
                                ...
                                className="w-[50px] text-left small-text"
                              >
                                ECO
                              </th>
                            </tr>
                              ...
                              (item, index) => (
                                ...
                                >
                                  <td
                                    ...
                                    className="text-[#0F19AF] pl-3 hover:underline hover:cursor-pointer xs-small-text"
                                  >
                                    {item?.role_str === "(WK)"
                                      ? "(WK)"
                                      : item?.role_str === "(C)"
                                  ...
                                  <td className="xs-small-text">{item.run0}</td>
                                  <td className="xs-small-text">
                                    {item.wickets}
                                  </td>
                                  <td className="xs-small-text">
                                  ...
                                  <td className="xs-small-text">{item.econ}</td>
                                  <td className="xs-small-text">
                                    {item.zeros}
                                  </td>
                                </tr>
                      ...
                      <table className="w-full">
                        <thead className="border-b">
                          ...
                          >
                            <th
                              style={{ borderRadius: "10px 0 0 0" }}
                              className="w-[350px] pl-3 text-left overflow-hidden small-text"
                            >
                              Powerplays
                            </th>
                            <th className="w-[150px] text-left small-text"> Over</th>
                            <th
                              style={{ borderRadius: "0 10px 0 0" }}
                              className="w-[150px] text-left small-text"
                            >
                              Runs
                            </th>
                          </tr>
                        ...
                        <tbody>
                          <tr className="border-b">
                            ...
                            <td className="xs-small-text">{squadData?.innings?.[0]?.result}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                      ...
                      <table className="w-full">
                        <thead className="border-b">
                          <tr
                            ...
                            style={{ borderRadius: "10px 10px 0 0" }}
                          >
                            <th className="w-[350px] pl-3 text-left overflow-hidden small-text">
                              Fall Of Wickets
                            </th>
                            <th className="w-[150px] text-left small-text"></th>
                            <th className="w-[150px] text-left small-text">Score</th>
                            <th className="w-[150px] text-left small-text">Over</th>
                          </tr>
                        </thead>
                        <tbody>
                          {squadData?.innings?.[0]?.fows?.map((item, index) => (
                            <tr className="border-b">
                              <td
                                style={{ color: "#0F19B6" }}
                                className="pl-3 hover:underline hover:cursor-pointer xs-small-text"
                                onClick={() =>
                                  navigate(
                                    `/profiles/${
                                      item?.batsman_id
                              ...
                              <td className="pr-3 xs-small-text" >{item?.how_out}</td>
                              <td className="pl-3 xs-small-text">
                                {item?.score_at_dismissal}
                              </td>
                              <td className="text-[#0F19AF] pt-2 pl-3 xs-small-text">
                  ...
                  <div className="small-padding">
                    <div className="w-[680px]  mt-2 mb-2 bg-[white] rounded-lg  shadow-lg full-width">
                      ...
                      <table className="m-2">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="w-[300px] xs-small-text"></th>
                          ...
                          {squadData?.innings?.[1]?.batsmen?.map(
                            (item, index) => (
                              <tr key={index} className="border-b">
                                ...
                                <td className="xs-small-text">{item.how_out}</td>
                                <td className="xs-small-text">{item.runs}</td>
                                <td className="xs-small-text">{item.balls_faced}</td>
                                <td className="xs-small-text">{item.fours}</td>
                                <td className="xs-small-text">{item.sixes}</td>
                                <td className="flex items-center xs-small-text">
                                  {item.strike_rate}
                                </td>
                              </tr>
                      ...
                      <div className="border-b  ml-2 mr-2">
                        <div className="flex justify-between w-[550px] full-width">
                          <div className="text-slate-400 xs-small-text bold-font">EXTRAS</div>
                          <div className="text-slate-400 flex xs-small-text bold-font">
                            {formatExtraRuns(
                      ...
                      <div className="border-b ml-2 mr-2">
                        <div className="flex  justify-between w-[550px] full-width">
                          <div className="text-slate-400 xs-small-text bold-font">TOTAL</div>
                          <div className="flex xs-small-text bold-font">
                      ...
                      <table className="p-2">
                        <thead className="border-b">
                          ...
                          >
                            ...
                            <th className="w-[50px] text-left small-text">O</th>
                            <th className="w-[50px] text-left small-text">M</th>
                            <th className="w-[50px] text-left small-text">R</th>
                            <th className="w-[50px] text-left small-text">W</th>
                            <th className="w-[50px] text-left small-text">NB</th>
                            <th className="w-[50px] text-left small-text">WD</th>
                            <th
                              style={{ borderRadius: "0 10px 0 0" }}
                              className="w-[50px] text-left small-text"
                            >
                          ...
                          {squadData?.innings?.[1]?.bowlers?.map(
                            (item, index) => (
                              <tr style={{ borderBottom: "1px solid #E5E7EB" }}>
                                ...
                                <td className="xs-small-text">{item.overs}</td>
                                <td className="xs-small-text">{item.maidens}</td>
                                <td className="xs-small-text">{item.run0}</td>
                                <td className="xs-small-text">{item.wickets}</td>
                                <td className="xs-small-text">{item.noballs}</td>
                                <td className="xs-small-text">{item.wides}</td>
                                <td className="xs-small-text">{item.econ}</td>
                                <td className="xs-small-text">{item.zeros}</td>
                              </tr>
                            )
                          )}
                        </tbody>
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          <tr className="border-b">
                            ...
                            <td className="xs-small-text">{squadData?.innings?.[1]?.result}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div>
                      <div className="w-[680px]  mt-2 mb-2 bg-[white] rounded-lg  shadow-lg full-width">
                        ...
                        <table className="m-2">
                          <thead>
                            <tr className="border-b">
                              <th className="w-[150px] text-left small-text ">Batter</th>
                              <th className="w-[300px]"></th>
                              <th className="w-[50px] text-left small-text">R</th>
                              <th className="w-[50px] text-left small-text">B</th>
                              <th className="w-[50px] text-left small-text">4S</th>
                              <th className="w-[50px] text-left small-text">6S</th>
                              <th className="w-[50px] small-text">SR </th>
                            </tr>
                          </thead>
                          <tbody>
        ...
        <div>
          <div className="mt-5 shadow-2xl w-[680px] ml-3 full-width zero-margin upper-margin-medium small-padding">
            <div
              style={{ borderRadius: "10px 10px 0 0" }}
            ...
            <div className="flex justify-between border-b">
              ...
              <div className="text-slate-400 mr-2 xs-small-text">{squadData?.toss?.text}</div>
            </div>
            <div className="flex justify-between border-b">
              <div
                className="text-slate-400 ml-2 xs-small-text"
            ...
            <div className="flex justify-between border-b">
              ...
              <div className="text-slate-400 mr-2 xs-small-text">{squadData?.referee}</div>
            </div>
          </div>
        </div>
      </div>
