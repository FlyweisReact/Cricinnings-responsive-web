    ...
    <div className="px-4 py-8">
      <div class="bg-white p-8 zero-padding">
        ...
        <div>
          ...
          <h2>
            <strong className="small-text" style={{ fontSize: "22.5px" }}>
          ...
          <h2>
            <strong className="small-text" style={{ fontSize: "22.5px" }}>Advertisement Policy</strong>
          </h2>
          <p>
            <span style={{ fontSize: "13px", color: "rgb(33,33,33)" }}>
          ...
          <h2>
            <strong style={{ fontSize: "22.5px" }}>Consent</strong>
          </h2>
          <p>
            <span style={{ fontSize: "13px", color: "rgb(33,33,33)" }}>
