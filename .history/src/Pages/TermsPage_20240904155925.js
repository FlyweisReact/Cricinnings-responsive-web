    ...
    <div className="">
      <div className="container_terms full-width" style={{ width: "95%", margin: "auto" }}>
        <div class="bg-white p-8 max-w-4xl mx-auto small-padding">
          ...
          <p class="mb-4 text-sm text-gray-600">Please read the below terms and conditions carefully before using our website, CricInnings accessible at https://cricinnings.com</p>
