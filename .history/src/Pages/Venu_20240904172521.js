    ...
    <div className="">
      <div className="bg-[white] pl-2 pt-2 pr-2">
        ...
        <div className="flex mt-2 justify-center pb-5">
          <div className="w-[950px] pb-5 bg-[white] flex justify-center gap-5 pt-5 column-flex full-width">
            <div className="left w-[700px] h-[1100px] shadow-2xl full-width">
            ...
            <div className="w-[250px]  mt-10 full-width zero-marign">
              <CurrentSeries />
              <RankingSeries />
            </div>
          </div>
