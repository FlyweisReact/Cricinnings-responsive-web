...
import { CustomSlider } from "../Components/Sliders/Slider";
import { populatMatchConfig } from "../Components/Sliders/SwiperConfig";
import { RenderTestCard } from "../Components/Sliders/SwiperComponent";
  ...
  return (
    <div className="max-container">
      ...
      {sliderData && (
        <CustomSlider
          data={sliderData}
          swiperConfig={populatMatchConfig}
