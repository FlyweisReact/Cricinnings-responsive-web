...
const Fantasytips = () => {
  ...
  const getAllHomePageBanners = () => {
    GetData("userAuth/getAllPosts").then((res) => {
      const topBanner = res?.data?.filter((item) => item?.title === "FANTASY_TIP_top");
            ...
            <div className="w-[250px] mt-10 zero-margin full-width">
              ...
              <div className="bg-[white] pt-3 pb-3 rounded-lg mt-2 box-shadow-container small-padding">
                <div className="flex justify-between p-2">
                  <div className="text-sm font-semibold small-font">RANKING’s</div>
                  <div>
