          ...
          {mainCategory === "batting" && (
            <>
              <div>
                ...
                >
                  <thead>
                    <tr>
                      ...
                      <th style={{ backgroundColor: "rgb(231,231,231)" }}  className='small-text'>
                        Player
                      </th>
                      <th
                        style={{
                ...
                <div
                  className="w-[680px] pb-5 mt-2 bg-white rounded-lg full-width box-shadow-container display-none"
                >
                  <div className="h-[70px] bg-[#E7E7E7] flex justify-between items-center pl-5 pr-5">
                    <div className="font-semibold small-text">Position</div>
                    <div className="font-semibold small-text">Player</div>
                    <div className="font-semibold small-text">Ranking</div>
                  </div>
                  <div className="mt-2 flex flex-col gap-5">
                    <div className="flex items-center justify-between ml-10 mr-10">
                      <div className="xs-small-text">1</div>
                      <div className="xs-small-text">-</div>
                      <div className="flex items-center gap-4">
                        <img src={men} alt="" className="w-[50px] h-[50px]" />
                        <div className="flex flex-col">
                          <span className="font-semibold xs-small-text">Kane Williamson</span>
                          <span className="text-[12px] xs-small-text">NEW ZEALAND</span>
                        </div>
                      </div>
                      <div className="xs-small-text">650</div>
                    </div>
          ...
          {mainCategory === "bowling" && (
            <>
              <div>
                ...
                <div
                  className="w-[680px] pb-5 mt-2 bg-white rounded-lg full-width box-shadow-container"
                >
                  <div className="h-[70px] bg-[#E7E7E7] flex justify-between items-center pl-5 pr-5">
                    <div className="font-semibold small-text">Position</div>
                    <div className="font-semibold small-text">Player</div>
